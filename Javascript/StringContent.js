...
let contentSnooze = {
    sleepMore:`
    <h1 id="start-title">"It is never too <span class="span-title">late</span> to be what you might have been, or is it?"</h1>
    ...
    cloth:`
    <h1 id="start-title">"Life isn't <span class="span-title">perfect</span> but your outfit can be."</h1>
    ...
    subway:`
    <h1 id="start-title">"The problem is not to find the <span class="span-title">answer</span>, it's to face the answer."</h1>
    ...
    bus:`
    <h1 id="start-title">"Sometimes it's good to miss a bus. It <br> might be the <span class="span-title">wrong</span> bus."</h1>
...
let contentSnoozeBus = {
    ...
    run:`
    <h1 id="start-title">"ohhhhhh <span class="span-title">shit</span>"</h1>
    ...
    wait:`
    <h1 id="start-title">"Don´t depend too much on anyone in this world. Even your <span class="span-title">shadow</span> leaves you when you´re in the dark."</h1>
    ...
    stopBleeding:`
    <h1 id="start-title">"It´s not the good that <span class="span-title">dies</span><br>young, it´s the lucky."</h1>
...
let contentSnoozeSub = {
    ...
    bonJovi:`
    <h1 id="start-title">"It's my life, it's <span class="span-title">now</span> or never, I ain't gonna live forever."</h1>
    ...
    magic:`
    <h1 id="start-title">"Call it magic, call it true, I call it <span class="span-title">magic</span> when i'm with you"</h1>
    <p class="start-text">Gotta give you some props on your music taste, but either way I guess there is nothing more to then to just look at other people on the subway. It's going to be a long trip to school. So you have a lot of thinking to do, don't you?</p>
    <div class="choices-btns"> 
    <button id="1" class="choice" onclick="manipluationSnoozeSubWait()">Wait</button>
    </div>`,
    ...
    wait:`
    <h1 id="start-title">"Somewhere, something incredible is <span class="span-title">waiting</span> to be know. Or something bad, I don't remember."</h1>
    ...
    hide:`
    <h1 id="start-title">"When there is nothing left to hide, there is <span class="span-title">nothing</span> left to seek."</h1>
    ...
    walk:`
    <h1 id="start-title">"We all - in the end - die <span class="span-title">in medias res</span>. In the middle of a story."</h1>
    <p class="start-text">Ohhh wow. That must have hurt? A little stab in your belly can't be dangeours. Hahah just kidding, you are probably going to die. But who are you to blame? Me? Really? I don't think so buddy, this is all on you. Maybe next time, you shouldn't hit the snooze button. Your lucky I like you, i will give you another chance. Just promise me to not fuck this one up. </p>
    <div class="choices-btns"> 
    <button id="1" class="choice" onclick="manipulationStart()">Get another chance</button>
    </div>`
...
let contentEarly = {
    takeShower:`
    <h1 id="start-title">"Best <span class="span-title">ideas</span> come in the shower."</h1>
    ...
    InShower:`
    <h1 id="start-title">"Long showers, loud music and <span class="span-title">deep</span> thoughts."</h1>
    ...
    dontTakeShower:`
    <h1 id="start-title">"Crusty, <span class="span-title">dusty</span> and musty."</h1>
    ...
    answerCall:`
    <h1 id="start-title"><span class="span-title">People</span> who creates <br><span class="span-title">their</span> own drama, <br><span class="span-title">deserves</span> their own karma.</h1>
    <p class="start-text"></p>
    <div class="choices-btns"> 
    <button id="1" class="choice" onclick="manipluationEarlyHangUp()">Hang up</button>
    </div>`,
    hangUp:`
    <h1 id="start-title">"Life is to short to be <span class="span-title">normal</span>, embrace the weird."</h1>
    ...
    dontAnswerCall:`
    <h1 id="start-title">"The more i think, the <span class="span-title">confused</span> I get</h1>
    ...
    breakfast:`
    <h1 id="start-title">"Breakfast is the most <span class="span-title">important</span> meal of the day."</h1>
...
let contentEarlySub = {
    ...
    eminem:`
    <h1 id="start-title">"And I just can't keep living this way, So starting <span class="span-title">today</span>, I'm breaking out of this cage."</h1>
    <p class="start-text">Gotta give you some props on your music taste, but either way I guess there is nothing more to then to just look at other people on the subway. It's going to be a long trip to school. So you have a lot of thinking to do, don't you?</p>
    <div class="choices-btns"> 
    ...
    rip:`
    <h1 id="start-title">"I can't  have it, I <span class="span-title">can't</span> have it, any other way."</h1>
    <p class="start-text">Gotta give you some props on your music taste, but either way I guess there is nothing more to then to just look at other people on the subway. It's going to be a long trip to school. So you have a lot of thinking to do, don't you?</p>
    <div class="choices-btns"> 
    <button id="1" class="choice" onclick="manipluationEarlyZone()">Zone out</button>
    </div>`,
    ...
    zoneOut:`
    <h1 id="start-title">"Observe the space between your thoughts, then <span class="span-title">observe</span> the observer."</h1>
    ...
    buyTicket:`
    <h1 id="start-title">"Half the time you think your <span class="span-title">thinking</span> you’re actually listening."</h1>
    ...
    dontBuyTicket:`
    <h1 id="start-title">"Once you develop that <span class="span-title">'it is what it is'</span> mentality. A lot of stuff stops bothering you."</h1>
...
let contentEarlyDrive = {
    driving: `
    <h1 id="start-title">"Never drive faster than your guardian <span class="span-title">angel</span> can fly."</h1>
    ...
    driveOut: `
    <h1 id="start-title">"Your best <span class="span-title">teacher</span>, is your last mistake."</h1>
    ...
    weak: `
    <h1 id="start-title">"No thank you is what i <span class="span-title">should</span> have said, I should be in bed."</h1>
    ...
    blackbear: `
    <h1 id="start-title">"Feel like I can't trust <span class="span-title">nobody</span>, even day ones. Wath out for them snake ones."</h1>
    <p class="start-text">Your music taste is just on point i got to say. We are soon at your school either way. Scratch that, we are here already. Just park in the parking lot.</p>
    <div class="choices-btns"> 
    <button id="1" class="choice" onclick="manipluationEarlySchool()">Park the car</button>
    </div>`
...
let contentSchool = {
    walk:`
    <h1 id="start-title">"As you start to walk out on <span class="span-title">the way</span>, the way appears."</h1>
    ...
    sayHello:`
    <h1 id="start-title">"Life is a matter of choices, and every <span class="span-title">choice</span> you make makes you."</h1>
    ...
    joinThem:`
    <h1 id="start-title">"May your choices reflect your <span class="span-title">hopes</span>, not your fears."</h1>
    ...
    stopFight:`
    <h1 id="start-title">"Life is the <span class="span-title">sum</span> of all your choices."</h1>
    <p class="start-text">
    ...
    sayNo:`
    <h1 id="start-title">"Don't base your decisions on the <span class="span-title">advice</span> of those who don't have to deal with the results."</h1>
